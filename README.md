[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=frediej_VendMachine&metric=coverage)](https://sonarcloud.io/summary/new_code?id=frediej_VendMachine)
